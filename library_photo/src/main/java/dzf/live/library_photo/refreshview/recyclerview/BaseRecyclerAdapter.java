package dzf.live.library_photo.refreshview.recyclerview;
...
import dzf.live.library_photo.refreshview.XRefreshView;
...
public abstract class BaseRecyclerAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public VH onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return (VH) onCreateViewHolder(parent, viewType, true);
    }
     ...
     */
    public abstract RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType, boolean isItem);
